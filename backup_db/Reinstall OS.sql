...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$120000$RuMX03X9BZfq$O356T/OCRFmXn8WCVG8y/DDoQQ+mFnDD8oUTDRoW3CA=','2019-06-10 09:56:41.814698',1,'sudoadmin','','','gostev.dy@msc15.ru',1,1,'2019-02-26 17:02:34.386711'),(2,'pbkdf2_sha256$120000$HStfQPC5EKTH$ipxes4eCJrF0UwMnwlYF/f/E/0ED7t1zuFeyvYnHoLU=','2019-03-02 05:47:25.713808',1,'gostev.dy','','','',1,1,'2019-03-02 05:47:07.000000');
...
INSERT INTO `django_content_type` VALUES (2,'admin','logentry'),(4,'auth','group'),(3,'auth','permission'),(5,'auth','user'),(6,'contenttypes','contenttype'),(9,'django_summernote','attachment'),(10,'News','attachment'),(8,'News','post'),(7,'sessions','session'),(1,'UserProfiles','profile');
...
CREATE TABLE `news_attachment` (
  ...
  `apost_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `News_attachment_apost_id_00744797_fk_News_post_id` (`apost_id`),
  CONSTRAINT `News_attachment_apost_id_00744797_fk_News_post_id` FOREIGN KEY (`apost_id`) REFERENCES `news_post` (`id`)
...
LOCK TABLES `news_attachment` WRITE;
/*!40000 ALTER TABLE `news_attachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `news_attachment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-06-21 16:40:27
